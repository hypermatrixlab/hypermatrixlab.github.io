...
/* ---- thesis abstract ---- */
.thesis-papers .tp-overview {
  padding-bottom: 3rem;
  margin-bottom: 3rem;
  border-bottom: 1px solid var(--global-divider-color);
}

.thesis-papers .tp-overview .tp-h {
  margin-top: 0;
}
